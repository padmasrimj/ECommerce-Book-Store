...
<%--                <a href="<c:url value="/order/${cartId}" />" class="btn btn-success pull-right"><span class="glyphicon glyphicon-shopping-cart"></span> Check out</a>--%> 
               		<a href="Payment.jsp" class="btn btn-success pull-right"><span class="glyphicon glyphicon-shopping-cart"></span> Check out</a>
               </div>
                ...
                <a href="<c:url value="/viewBids.jsp" />" class="btn btn-default">Continue Shopping</a>
            </div>
        </section>
